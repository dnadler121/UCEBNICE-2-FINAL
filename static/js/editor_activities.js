  ...
  function buildCards(){
    ...
    function imagesMode(){
      ...
      document.getElementById('saveActivity').onclick=()=>{
        ...
        state.push({type:'cards',title:paTitle.value,prompt:paPrompt.value,image:'',video:'',config:{mode:'images',cards},include_final:paFinal.checked});renderList();buildCards();
      };
    }
